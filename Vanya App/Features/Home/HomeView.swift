...
//
//    // Getting screen width and height to adjust the Map
...
//                            .scaledToFit() // Ensures full screen coverage
////                            .frame(width: bounds.width - 10, height: bounds.height - 300) // sir
...
struct HomeView: View {
        ...
        NavigationStack(path: $navigationPath) {
            GeometryReader { geo in
                ZStack {
                    ...
                    // MARK: - 1. MESH GRADIENT BACKGROUND
                    MeshGradient(
                        width: 3,
                        height: 3,
                        points: [
                    ...
                    ZStack {
                        ...
                        Image("india_map")
                            ...
                            .rotation3DEffect(
                                .degrees(Double(-dragOffset.height / 30)),
                                axis: (x: 1, y: 0, z: 0)
                            )
                            .offset(
                            ...
                            .shadow(
                                ...
                                y: -dragOffset.height / 5
                            )
                    }

                    // MARK: - 3. TITLE + BOTTOM BAR
                    VStack {
    ...
    // MARK: - Bottom Region Bar
    private var regionBottomBar: some View {
        HStack(spacing: 36) {
